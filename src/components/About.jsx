...
const About = () => {
  return (
    <div className="bg-color-base-200 min-h-screen py-25 px-4 lg:px-20">
      <motion.div
        className="container mx-auto bg-base-200 p-8 rounded-3xl shadow-2xl backdrop-blur-md"
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <h2 className="text-3xl font-bold">
              Why Choose <span className="text-red-800 hover:underline">ReadRipple</span>?
            </h2>
            ...
            <button className="btn btn-primary hover:bg-rose-800 text-white mt-4">
              Join the Community
            </button>
          </motion.div>
        </div>
